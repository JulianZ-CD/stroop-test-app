  ...
  return (
    <main>
      <div className="header">
        {/* <h1>{t("home.title")}</h1> */}
        <p>SYDE640 Group 1: Julian (Web Dev); Brad, Yufei (Data Analyst)</p>
        <select
          value={locale}
      ...
      <div className="stats-section">
        ...
        <p>{t("home.statsSection.description")}</p>
        <button onClick={() => router.push("/stats")}>{t("home.statsSection.viewStats")}</button>
      </div>
    </main>
  );
}
